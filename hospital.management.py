...
conn = sqlite3.connect(r'C:\Users\yashw\Desktop\database.db')
c = conn.cursor()
ids = []
number = []
patients = []
...
# creating the frames in the window
        self.main = Frame(window, width=2000, height=1200, bg="lightblue")
...
window.iconbitmap(r'C:\Users\yashw\Desktop\medkit.ico')
